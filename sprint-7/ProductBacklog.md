...
>- **Sprint 7 — Dodano:** Account Settings (PB-45); Prikaz statusa obrade transkripata (PB-46); Agent queue — pregled i potvrđivanje Q&A parova (PB-47)
---
...
| 45 | Account Settings | Upravljanje korisničkim nalogom — promjena korisničkog imena, lozinke i profilnih podataka | feature | Medium | 5 | Done | MVP inkrement |
...
| 47 | Agent queue — pregled i potvrđivanje Q&A parova | Agent ima vlastiti prikaz s listom Q&A parova na čekanju koje pregleda i potvrđuje ili odbija, slično kao admin | feature | High | 8 | Not Started | / |
