...
|----|-------------|------------|-----|----------|----------|--------|--------|----------|
| 1 | Istražiti RAG chatbot implementaciju | Istražiti kako funkcioniše RAG pristup i kako ga implementirati u sistemu | research | High | 5 | To Do | Sprint 1 | Osnova arhitekture |
| 2 | Istražiti najpogodnije vektorske baze | Pregledati besplatno dostupne vektorske baze koje se lako integrišu sa AI API-jima | research | High | 5 | To Do | Sprint 1 | Izbor tehnologije |
| 3 | Istražiti neophodne API-eve | Istražiti embeddings API, LLM API i druge servise potrebne za sistem | research | High | 3 | To Do | Sprint 1 | Integracija sa AI |
| 4 | Team Charter |  |  | High | 3 | To Do | Sprint 1 |  |
| 5 | Product Vision |  |  | High | 3 | To Do | Sprint 1 | |
| 6 | Identifikacija i mapiranje stakeholdera | Mapiranje svih relevantnih strana |  | High | 3 | To Do | Sprint 1 | |
| 7 | Definisanje MVP opsega | Deinisanje šta ulazi u MVP |  | High | 3 | To Do | Sprint 1 | |

| ID | Naziv stavke | Kratak opis | Tip | Prioritet | Procjena | Status | Sprint | Napomena |
|----|-------------|------------|-----|----------|----------|--------|--------|----------|
| 8 | User Stories | Pisanje user stories za krajnje korisnike (klijent, agent i admin) | feature | High | 8 | To Do |  | JWT/session |
| 9 | Login i sign in | Autentifikacija korisnika | feature | High | 8 | To Do |  | JWT/session |
...
| 18 | Dictate opcija na Chatbotu | Omogućiti unos pitanja | feature | Medium | 5 | To Do |  | UX |
...
| ID | Naziv stavke | Kratak opis | Tip | Prioritet | Procjena | Status | Sprint | Napomena |
|----|-------------|------------|-----|----------|----------|--------|--------|----------|
| 22 | Evaluacija kvaliteta odgovora | Mehanizam za ocjenu odgovora  | feature | Medium | 5 | To Do | Sprint 4 | Feedback sistem |
