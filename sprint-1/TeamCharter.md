### _Naziv projekta: Sistem za treniranje i implementaciju AI chatbot asistenta na osnovu poziva iz call centra_

#### _2\. Template: Team Charter_

#### _Naziv tima: Tim 9_

#### _Članovi tima:_

- Ajdin Alihodžić (19270) - _aalihodzic5@etf.unsa.ba_
- Asja Festa (19518) - _afesta2@etf.unsa.ba_ 
- Emin Bihorac (19592) - _ebihorac1@etf.unsa.ba_
- Ena Gicić (18847) - _egicic1@etf.unsa.ba_
- Lamija Sarajlić (19401) - _lsarajlic1@etf.unsa.ba_
- Nejra Vatrić (19672) - _nvatric1@etf.unsa.ba_
- Tarik Fetahović (19757) - _tfetahovic1@etf.unsa.ba_
- Šaban Zolj (19333) - _szolj1@etf.unsa.ba_

#### _Način komunikacije:_

- _Primarni kanal komunikacije:_  
    Viber grupa i Google Meet

- _Očekivano vrijeme odgovora:_  
    U toku dana

- _Način zakazivanja sastanaka:_  
   Dogovor u grupi, uz potvrdu svih članova
...
- _Kako se član upozorava:_  
Predstavnik grupe tom članu skreće pažnju u privatnoj poruci, a zatim u grupi ukoliko se problem nije riješio ili se opet ponavlja.

- _Kada se problem prijavljuje nastavnom osoblju:_  
